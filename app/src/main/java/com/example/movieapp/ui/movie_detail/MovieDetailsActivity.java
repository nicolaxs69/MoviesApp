...
import com.example.movieapp.ui.movie_detail.adapter.CastAdapter;
...
public class MovieDetailsActivity extends AppCompatActivity implements IMovieDetailsView.View {
    ...
    public void setDataToViews(Movie movie) {
        ...
        if (movie != null) {
            ...
            Glide.with(this)
                    .load(ApiConnection.BACKDROP_BASE_URL + movie.getBackdropPath())
            ...
            tvTaglineValue.setText(movie.getTagline() != null ? movie.getTagline() : "Not Found");
            tvHomepageValue.setText(movie.getHomepage() != null ? movie.getHomepage() : "Not Found");
            tvRuntimeValue.setText(movie.getRunTime() != null ? movie.getRunTime() : "Not Found");
        }
