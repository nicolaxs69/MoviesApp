...
public class MovieUpcomingModel implements IMovieUpcomingView.Model {

    private final String TAG = "MovieUpcomingModel";
    ...
    public void getMovieList(final OnFinishedListener onFinishedListener, int pageNo) {
        ...
        Call<MovieResponse> call = apiService.getUpcomingMovies(API_KEY, pageNo);
